...
def genDoubleLU(value, base):
    ...
    # B prime states 
    Bprime = uc.state(str(sqrtLen) + "B'")
    genSys.add_State(Bprime)
    Bprime2 = uc.state(str(sqrtLen) + "B''")
